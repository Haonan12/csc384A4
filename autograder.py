...
if __name__ == '__main__':
    ...
    os.system("python3 tagger.py -d training1.txt training2.txt training3.txt -t test4.txt -o autooutput.txt")
    ...
    with open("autooutput.txt", "r") as output_file, \
        ...
        results_file.write(f"Total accuracy: {total_matches / len(output)}.\n")
        print("Total accuracy: {}.".format(total_matches / len(output)))
